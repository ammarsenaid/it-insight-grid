...
export function buildSeed(): DataState {
  ...
  const ticketSeed = [
    { sub: "Cannot connect to VPN", cat: "Network", sub2: "VPN", type: "incident", prio: "high", status: "open", sla: "warning", hostHint: "FIREWALL01", team: "Network", svc: "Remote Access", source: "email" as const },
    { sub: "Outlook crashes on launch", cat: "Applications", sub2: "Email", type: "incident", prio: "normal", status: "in_progress", sla: "ok", hostHint: "M365-TENANT", team: "Service Desk", svc: "Email", source: "portal" as const },
    { sub: "New starter laptop request", cat: "Hardware", sub2: "Workstation", type: "request", prio: "normal", status: "open", sla: "ok", hostHint: undefined, team: "Service Desk", svc: "Onboarding", source: "service_catalog" as const },
    { sub: "File share permissions error", cat: "Storage", sub2: "Shares", type: "incident", prio: "high", status: "waiting", sla: "ok", hostHint: "FILESERVER01", team: "Infrastructure", svc: "File Storage", source: "email" as const },
    { sub: "DC01 disk space critical", cat: "Infrastructure", sub2: "Servers", type: "incident", prio: "critical", status: "in_progress", sla: "breached", hostHint: "DC01", team: "Infrastructure", svc: "Active Directory", source: "manual" as const },
    { sub: "Reset password for finance user", cat: "Identity", sub2: "Accounts", type: "request", prio: "low", status: "resolved", sla: "ok", hostHint: undefined, team: "Service Desk", svc: "Identity", source: "service_catalog" as const },
    { sub: "Backup job failed overnight", cat: "Backup", sub2: "Veeam", type: "incident", prio: "high", status: "open", sla: "warning", hostHint: "BACKUP01", team: "Infrastructure", svc: "Backup", source: "internal" as const },
    { sub: "Phishing email reported", cat: "Security", sub2: "Email", type: "incident", prio: "high", status: "in_progress", sla: "ok", hostHint: "M365-TENANT", team: "Security", svc: "Email", source: "email" as const },
    { sub: "Add VLAN 30 for IoT segment", cat: "Network", sub2: "VLAN", type: "change", prio: "normal", status: "open", sla: "ok", hostHint: "SWITCH-CORE-01", team: "Network", svc: "LAN", source: "manual" as const },
    { sub: "Printer offline on floor 2", cat: "Hardware", sub2: "Printer", type: "incident", prio: "low", status: "open", sla: "ok", hostHint: "PRINTSRV01", team: "Service Desk", svc: "Printing", source: "portal" as const },
    { sub: "Recurring AD replication warnings", cat: "Identity", sub2: "Directory", type: "problem", prio: "high", status: "in_progress", sla: "warning", hostHint: "DC02", team: "Infrastructure", svc: "Active Directory", source: "internal" as const },
    { sub: "Teams meeting audio issues", cat: "Applications", sub2: "Collaboration", type: "incident", prio: "normal", status: "waiting", sla: "ok", hostHint: "M365-TENANT", team: "Service Desk", svc: "Collaboration", source: "portal" as const },
    { sub: "SAN degraded disk replacement", cat: "Hardware", sub2: "Storage", type: "change", prio: "critical", status: "in_progress", sla: "warning", hostHint: "SANSTORAGE01", team: "Infrastructure", svc: "Storage", source: "manual" as const },
    { sub: "Install Adobe Acrobat", cat: "Applications", sub2: "Software", type: "request", prio: "low", status: "resolved", sla: "ok", hostHint: "WS-ADMIN-01", team: "Service Desk", svc: "Software", source: "service_catalog" as const },
    { sub: "Suspicious login from foreign IP", cat: "Security", sub2: "Identity", type: "incident", prio: "critical", status: "open", sla: "breached", hostHint: undefined, team: "Security", svc: "Identity", source: "internal" as const },
    { sub: "Add user to Marketing group", cat: "Identity", sub2: "Groups", type: "request", prio: "low", status: "resolved", sla: "ok", hostHint: undefined, team: "Service Desk", svc: "Identity", source: "service_catalog" as const },
    { sub: "Wi-Fi slow in conference room", cat: "Network", sub2: "Wi-Fi", type: "incident", prio: "normal", status: "open", sla: "ok", hostHint: "SWITCH-FLOOR2", team: "Network", svc: "Wi-Fi", source: "email" as const },
    { sub: "Schedule monthly patching window", cat: "Infrastructure", sub2: "Patching", type: "change", prio: "normal", status: "open", sla: "ok", hostHint: "HYPERV01", team: "Infrastructure", svc: "Patching", source: "manual" as const },
  ];
  ...
  return {
    ...
    ticketSettings: {
      ...
      mailbox: {
        address: "it-support@company.local",
        enabled: true,
        unknownFallback: "flag_review",
        fallbackRequester: "noah.help",
